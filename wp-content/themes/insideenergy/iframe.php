 ...
 * 1. Create a new page
 * 2. Set the 'template' option to "Iframe page"
 ...
 * How to embed the page:
    <div id="embed-iframe-container"></div>
	<script src="//example.com/wp-content/themes/insideenergy/js/pym.js"></script>
...
<?php wp_footer(); ?>
<script src="<?php echo get_stylesheet_directory_uri() ?>/js/pym.js?ver=20160502"></script>
<script type="text/javascript">
(function() {
var $ = jQuery,
